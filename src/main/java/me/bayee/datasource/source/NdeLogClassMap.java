...
public class NdeLogClassMap {
    private static final HashMap<Integer, MessageLite> logclassMap = new HashMap<Integer, MessageLite>();

    static {
        logclassMap.put(AuditEnum.LOGCLASS.LC_USERSESSION.getNumber(),
                AuditUsess.T_USER_SESSION.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_STREAM.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_OPER.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_TREASURY.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_TREAOPER.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_HBA.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_CPSPROXY.getNumber(),
                Cps.PROXY_LOG.getDefaultInstance().getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_IAM.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_DETOUR.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_EVENT.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_KEYANA.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_STATSANA.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_WARN.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_SUBJECT.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());

        logclassMap.put(AuditEnum.LOGCLASS.LC_DETOURANA.getNumber(),
                AuditLog.T_AUDIT_LOG.getDefaultInstance()
                        .getDefaultInstanceForType());
    }

    public static MessageLite get(int key) {
        return logclassMap.get(key);
    }
